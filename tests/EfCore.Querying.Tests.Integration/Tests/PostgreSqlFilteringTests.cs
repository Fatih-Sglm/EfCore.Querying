using EfCore.Querying.Tests.Integration.Data;
using EfCore.Querying.Tests.Integration.Entities;
using EfCore.Querying.Tests.Integration.Fixtures;
...
public class PostgreSqlFilteringTests : IClassFixture<PostgreSqlFixture>
{
    private readonly PostgreSqlFixture _fixture;

    public PostgreSqlFilteringTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task ApplyQueryFilterAsync_SkipAndTake_ReturnsPagedProducts()
    {
        ...
        var request = new QueryFilterRequest
        {
            Skip = 2,
            Take = 2,
            Sort = new List<SortDescriptor> { new SortDescriptor("Id", ListSortDirection.Ascending) }
        };
